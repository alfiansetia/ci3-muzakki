<div class="container">
    ...
    <form method="POST" action="<?= base_url('murid/add') ?>">
        ...
        <div class="form-group">
            ...
            <input name="nisn" type="text" class="form-control" id="nisn" placeholder="Masukkan NISN" value="<?= set_value('nisn'); ?>" required>
            <small class="text-danger">
